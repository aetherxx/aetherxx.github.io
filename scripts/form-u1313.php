...
{
	$to = 'anh@angelsinstead.net';
	$subject = 'postit Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U1314"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U1327"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Custom::</b></td><td>' . htmlentities($_REQUEST["custom_U1465"],ENT_COMPAT,'UTF-8') . '</td></tr>';
